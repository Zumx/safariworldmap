  ...
  return (
    <main className="map-root">
      ...
      <div className="overlay">
        ...
        <p>Every nature reserve on Earth, sourced live from OpenStreetMap. Zoom in and explore protected wilderness and safari country — from African savannas to remote wetlands.</p>
